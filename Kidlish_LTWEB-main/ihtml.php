...
<br>
    ...
    <div id="parentinfor" class="parentinfor">
        <form action="" autocomplete="off">
            ...
            <input type="text" id="fullname" class="form" placeholder="Eg: Kidlish" readonly>
            <label for="phone" class="label">Phone number</label>
            <input type="phone" id="phone" class="form" placeholder="Eg: +84 123456789" readonly>
            <label for="adr" class="label">Address</label>
            <input type="adr" id="adr" class="form" placeholder="Eg: 280 An Dương Vương" readonly>
            <label for="rela" class="label">Email</label>
            <input type="rela" id="rela" class="form" placeholder="Eg: Mother/Father" readonly>
            <label for="acc" class="label">Account Type</label>
            <input type="Account Type" id="acc" class="form" placeholder="Eg: Normal" readonly>
          </form>
          <script>
            $(document).ready(function() {
  $.ajax({
  ...
  $.ajax({
    ...
    <br>
    <a href="ihtmledit.php"> <button class="button1" style="margin-left: 300px;">Edit Parent Info</button></a> &nbsp; &nbsp; &nbsp; &nbsp;
