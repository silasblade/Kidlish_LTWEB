...
<html>
 ...
 <div>   
        ...
        <h1 style="font-size: 39pt; text-align: center;">Get information</h1>
        <br>
        <br>
        <br>
        <hr>
        ...
        <br>
        <br>
        <div class="parentinfor4">
         <div class = "my-div-class2">

         <a href="admin31.php"><button class="signin-submit3"> <h2 style="margin-top: -17px;">Get Game Score Report</h2>  </button> </a>
         &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
         <a href="admin32.php"><button class="signin-submit3"><h2 style="margin-top: -17px;">Get Test Score Report</h2></button> </a>
